...
TOPIC_PRIORITIES = {
    ...
    "афиша/мероприятия": "подробно, обязательно указывай дату, время и место",
    "рекомендации/подборки": "подробно, сохраняй все детали",
    "локальные события (Вологда)": "подробно, это важно для читателя",
}
